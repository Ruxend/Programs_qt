...
"""二级窗体内容"""
class ui_Getfilelist():
	# def __init__(self, parent=None):
	# 	super().__init__(parent)
	def setupUi(self, QMainWindow):
		self.setWindowTitle("Tool of FilenameToExcel") 			# 设置窗口标题
	...
	def createWidget(self):
		...
		"""控件内容"""
		conText = (("请输入Excel对象名称:", "entry_1"),
					("请输入Sheet对象名称:", "entry_2"),
					("请选择工作簿保存位置:", "entry_3", "browse_1"),
					("请选择获取对象文件位置:", "entry_4", "browse_2"),
					("请输入获取对象文件格式:", "entry_5"))
		for self.index, self.r in enumerate(conText):
			for self.cindex, self.c in enumerate(self.r):
				if self.c == "请输入Excel对象名称:":
					self.label_1 = QLabel()
				...
				elif self.c == "请输入Sheet对象名称:":
					self.label_2 = QLabel()
					self.label_2.setObjectName("label_2")
					self.label_2.setText(_translate("self", self.c))
					self.label_2.setFont(QFont("微软雅黑", 9, QFont.Normal))
					self.groupbox_1_grid_1.addWidget(self.label_2, self.index, self.cindex)
				elif self.c == "entry_2":
					self.entry_2 = QLineEdit()
					self.entry_2.setObjectName("entry_2")
					self.entry_2.setFont(QFont("微软雅黑", 9, QFont.Normal))
					self.entry_2.setPlaceholderText("Please input here(Must be selected)") 	# 设置浮显文字
					self.entry_2.setAlignment(Qt.AlignLeft)
					self.label_2.setBuddy(self.entry_2) 					# 伙伴关系
					self.groupbox_1_grid_1.addWidget(self.entry_2, self.index, self.cindex, 1, 6)
				elif self.c == "请选择工作簿保存位置:":
					self.label_3 = QLabel()
					self.label_3.setObjectName("label_3")
					self.label_3.setText(_translate("self", self.c))
					self.label_3.setFont(QFont("微软雅黑", 9, QFont.Normal))
					self.groupbox_1_grid_1.addWidget(self.label_3, self.index, self.cindex)
				elif self.c == "entry_3":
					self.entry_3 = QLineEdit()
					self.entry_3.setObjectName("entry_3")
					self.entry_3.setFont(QFont("微软雅黑", 9, QFont.Normal))
					self.entry_3.setPlaceholderText("Please input here(Must be selected)") 	# 设置浮显文字
					self.entry_3.setAlignment(Qt.AlignLeft)
					self.label_3.setBuddy(self.entry_3) 					# 伙伴关系
					self.groupbox_1_grid_1.addWidget(self.entry_3, self.index, self.cindex, 1, 6)
				elif self.c == "browse_1":
					self.browse_1 = QPushButton()
					self.browse_1.setObjectName("browse_1")
					self.browse_1.setText(_translate("self", "Browse"))
					self.browse_1.setToolTip("Browse")
					self.browse_1.setFont(QFont("微软雅黑", 9, QFont.Normal))
					self.browse_1.setStyleSheet("QPushButton:hover{color:darkorange}")
					self.browse_1.clicked.connect(self.get_entry_3)  		# 连接槽
					self.groupbox_1_grid_1.addWidget(self.browse_1, self.index, self.cindex + 7)
				elif self.c == "请选择获取对象文件位置:":
					self.label_4 = QLabel()
					self.label_4.setObjectName("label_4")
					self.label_4.setText(_translate("self", self.c))
					self.label_4.setFont(QFont("微软雅黑", 9, QFont.Normal))
					self.groupbox_1_grid_1.addWidget(self.label_4, self.index, self.cindex)
				elif self.c == "entry_4":
					self.entry_4 = QLineEdit()
					self.entry_4.setObjectName("entry_4")
					self.entry_4.setFont(QFont("微软雅黑", 9, QFont.Normal))
					self.entry_4.setPlaceholderText("Please input here(Must be selected)") 	# 设置浮显文字
					self.entry_4.setAlignment(Qt.AlignLeft)
					self.label_4.setBuddy(self.entry_4) 							# 伙伴关系
					self.groupbox_1_grid_1.addWidget(self.entry_4, self.index, self.cindex, 1, 6)
				elif self.c == "browse_2":
					self.browse_2 = QPushButton()
					self.browse_2.setObjectName("browse_2")
					self.browse_2.setText(_translate("self", "Browse"))
					self.browse_2.setToolTip("Browse")
					self.browse_2.setFont(QFont("微软雅黑", 9, QFont.Normal))
					self.browse_2.setStyleSheet("QPushButton:hover{color:darkorange}")
					self.browse_2.clicked.connect(self.get_entry_4)  		# 连接槽
					self.groupbox_1_grid_1.addWidget(self.browse_2, self.index, self.cindex + 7)
				elif self.c == "请输入获取对象文件格式:":
					self.label_5 = QLabel()
					self.label_5.setObjectName("label_5")
					self.label_5.setText(_translate("self", self.c))
					self.label_5.setFont(QFont("微软雅黑", 9, QFont.Normal))
					self.groupbox_1_grid_1.addWidget(self.label_5, self.index, self.cindex)
				elif self.c == "entry_5":
					self.entry_5 = QLineEdit()
					self.entry_5.setObjectName("entry_5")
					self.entry_5.setFont(QFont("微软雅黑", 9, QFont.Normal))
					self.entry_5.setPlaceholderText("Please input here(It's up to you)") 	# 设置浮显文字
					self.entry_5.setAlignment(Qt.AlignLeft)
					self.label_5.setBuddy(self.entry_5) 							# 伙伴关系
					self.groupbox_1_grid_1.addWidget(self.entry_5, self.index, self.cindex, 1, 6)
		# "text"
